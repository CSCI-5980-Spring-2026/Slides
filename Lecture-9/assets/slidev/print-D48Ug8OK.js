import{f as _,a4 as u,e as s,g as t,t as o,T as c,F as h,aj as f,z as g,o as a,ad as v,d as x,j as b}from"../modules/vue-B6bnnurx.js";import{a as y,u as N,o as d}from"../index-DB0IC_3U.js";import{_ as k}from"./NoteDisplay.vue_vue_type_style_index_0_lang-JOE7TgAS.js";import"../modules/shiki-rSdWAxPz.js";const T={id:"page-root"},w={class:"m-4"},L={class:"mb-10"},V={class:"text-4xl font-bold mt-2"},j={class:"opacity-50"},B={class:"text-lg"},H={class:"font-bold flex gap-2"},S={class:"opacity-50"},z={key:0,class:"border-main mb-8"},A=_({__name:"print",setup(C){const{slides:m,total:p}=y();u(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
